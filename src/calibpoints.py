...
class calib_points:
    ...
    def callback1(self, data1):
        ...
        if cv_image1 != None:
            dst = cv2.warpPerspective(cv_image1, M, (1000, 1000), borderMode=cv2.BORDER_CONSTANT,
                                      borderValue=(255, 0, 255))
            allimg.append(dst)
        dsttemp = dst.copy()
        ...
        if cv_image2 != None:
            dst2 = cv2.warpPerspective(cv_image2, M2, (1000, 1000), borderMode=cv2.BORDER_CONSTANT,
                                       borderValue=(255, 0, 255))
            allimg.append(dst2)
        ...
        if cv_image3 != None:
            dst3 = cv2.warpPerspective(cv_image3, M3, (1000, 1000), borderMode=cv2.BORDER_CONSTANT,
                                       borderValue=(255, 0, 255))
            allimg.append(dst3)
        ...
        if cv_image4 != None:
            dst4 = cv2.warpPerspective(cv_image4, M4, (1000, 1000), borderMode=cv2.BORDER_CONSTANT,
                                       borderValue=(255, 0, 255))
            allimg.append(dst4)
        ...
        if cv_image5 != None:
            dst5 = cv2.warpPerspective(cv_image5, M5, (1000, 1000), borderMode=cv2.BORDER_CONSTANT,
                                       borderValue=(255, 0, 255))
            allimg.append(dst5)
        ...
        if cv_image6 != None:
            dst6 = cv2.warpPerspective(cv_image6, M6, (1000, 1000), borderMode=cv2.BORDER_CONSTANT,
                                       borderValue=(255, 0, 255))
            allimg.append(dst6)
            ...
            for x in range(1000):
                for y in range(1000):
                    ...
                    if A == 255 and B == 0 and C == 255:
                        dsttemp[x][y] = dsti[x][y]

                    else:
                        if A1 == 255 and B1 == 0 and C1 == 255:
                            dsttemp[x][y] = dsttemp[x][y]
        ...
        try:
            ...
            self.image_pub.publish(self.bridge.cv2_to_imgmsg(dsttemp, "bgr8"))
...
def main(args):
    ...
    arg_defaults = {
        #'source1': '/path1/image_raw',
        #'source2': '/path2/image_raw',
        #'source3': '/path3/image_raw',
        #'source4': '/path4/image_raw',
        #'source5': '/path5/image_raw',
        #'source6': '/path6/image_raw',

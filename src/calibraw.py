        ...
        for img in self.images:
            for x in range(1000):
                for y in range(1000):
                    ...
                    elif img[x][y] != (255, 0, 255):
                        output_image[x][y] = 0.5 * output_image[x][y] + 0.5 * img[x][y]
        try:
...
def main(args):
    ...
    arg_defaults = {
        ...
        'image_topics' : ['/watcher1/image_raw', '/watcher2/image_raw', '/watcher3/image_raw', '/watcher4/image_raw', '/watcher5/image_raw', '/watcher6/image_raw'],
        'calib_topic': '/calibratedraw/image_raw'
    }
